...
# Script para executar Cenário 1 - Teste A
# 2 peers, 10KB, bloco 1KB
...
echo "========================================"
echo "  Cenário 1 - Teste A"
echo "  2 peers, 10KB, bloco 1KB"
echo "========================================"
echo ""
...
if [ ! -f "$SCRIPT_DIR/../../../files/scenario1_file_a.bin" ]; then

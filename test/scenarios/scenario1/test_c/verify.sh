...
# Script para verificar resultado do Cenário 1 - Teste C

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
cd "$SCRIPT_DIR"

echo "========================================"
echo "  Verificação - Cenário 1 Teste C"
echo "========================================"
echo ""

ORIGINAL_FILE="../../../files/scenario1_file_c.bin"
DOWNLOADED_FILE="downloads/scenario1_file_c.bin"

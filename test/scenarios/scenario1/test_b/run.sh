...
# Script para executar Cenário 1 - Teste B
# 2 peers, 1MB, bloco 1KB
...
echo "========================================"
echo "  Cenário 1 - Teste B"
echo "  2 peers, 1MB, bloco 1KB"
echo "========================================"
echo ""
...
if [ ! -f "$SCRIPT_DIR/../../../files/scenario1_file_b.bin" ]; then

...
# Script para executar Cenário 2 - Teste A
# 4 peers, 20KB, bloco 4KB
...
echo "========================================"
echo "  Cenário 2 - Teste A"
echo "  4 peers, 20KB, bloco 4KB"
echo "========================================"
echo ""
...
if [ ! -f "$SCRIPT_DIR/../../../files/scenario2_file_a.bin" ]; then

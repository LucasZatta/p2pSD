...
# Script para executar Cenário 2 - Teste C
# 4 peers, 20MB, bloco 4KB
...
echo "========================================"
echo "  Cenário 2 - Teste C"
echo "  4 peers, 20MB, bloco 4KB"
echo "========================================"
echo ""
...
if [ ! -f "$SCRIPT_DIR/../../../files/scenario2_file_c.bin" ]; then

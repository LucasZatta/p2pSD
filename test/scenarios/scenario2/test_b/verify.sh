...
# Script para verificar resultado do Cenário 2 - Teste B

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
cd "$SCRIPT_DIR"

echo "========================================"
echo "  Verificação - Cenário 2 Teste B"
echo "========================================"
echo ""

ORIGINAL_FILE="../../../files/scenario2_file_b.bin"
...
for peer in b c d; do
    ...
    DOWNLOADED_FILE="downloads/scenario2_file_b.bin"
